# Django settings for theW4 project.

import socket
DEV_SERVERS = ['leia', 'Loki']
print('hostname = %s' % socket.gethostname())
if socket.gethostname() in DEV_SERVERS:
    DEBUG = True
    DEV = True
else:
    DEBUG = False
...
ADMINS = (
    ('Dimitris John Raptis', 'draptis@alternality.gr'),
)
...
STATIC_ROOT = '/srv/www/w4/current/static/'
...
STATICFILES_DIRS = (
    ...
    "/srv/www/w4/current/theW4/static",
)
...
ROOT_URLCONF = 'theW4.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'theW4.wsgi.application'
