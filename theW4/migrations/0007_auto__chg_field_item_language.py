...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('item', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theW4.Language'], null=True))

    def backwards(self, orm):

        # Changing field 'Item.language'
        db.alter_column('item', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['theW4.Language']))
